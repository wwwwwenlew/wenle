...
这是我自己做的功能模拟项目，不是公司项目，也没有用于真实的工业园区。

页面里的园区、建筑、人员位置、危险区域和报警信息都是模拟数据，没有接入定位设备、企业后台或真实人员数据。这个项目主要用于个人作品展示，也借此练习 Three.js 在业务页面中的使用方式。
